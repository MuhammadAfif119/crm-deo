...
const InstagramPosts = () => {
  ...
  const [platformActive, setPlatformActive] = useState(["instagram"]);
  ...
  const [data, setData] = useState({
    ...
    instagramOptions: {
      reels: false, //untuk reels
      shareReelsFeed: false, //untuk dibagikan ke feed (optional)
      audioName: "", //untuk audio reelsnya (optional)
      thumbnailOffset: 3000, //thumbnail reels
      coverUrl: "", //reels only
      stories: false, //untuk stories
