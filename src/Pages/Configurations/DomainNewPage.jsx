    ...
    <>
      ...
      <Container shadow="base" p="2">
        ...
        {textVerif ? (
          <Box p="5">
            <Text>
              Create an {textVerif.type} record for {data?.name} pointing to our
              server.
            </Text>
        ...
        {data?.verif ? (
          !data.isSubdomain ? (
            <Box p="5">
              <Text>
                Create an A record for {data?.name} pointing to our server.
              </Text>
              <HStack bgColor="gray.100" p="3" gap={2}>
                <Box>
                  <Text>Type</Text>
        ...
        {!isComplete ? (
          isLoading ? (
            <Button isLoading colorScheme="green" m="1" width="full">
              Save
            </Button>
          ) : (
            <Button
          ...
          <Button
            ...
            m="1"
            width="full"
            onClick={() => navigate("/configuration/domain")}
          >
            Complete
          </Button>
        )}
