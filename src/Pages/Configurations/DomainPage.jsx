	...
	return (
		...
		<Box>
			<HStack>
				...
				<Spacer />
				<Link to='new'>
					<Button colorScheme='green'>Add Domain</Button>
				</Link>
			</HStack>
							...
							<Tr key={i}>
								...
								<Td>
									<HStack textAlign='center'>
										...
										<Box ml='-5' mt='-2' w='10px' h='10px' bgColor='green' borderRadius='full' />
									</HStack>
								</Td>
								<Td>
									{
								...
								<Td >
									{showButton(x.domain) ? 
									<HStack>
										<RepeatIcon onClick={()=> checkDomain(i)} />
										<DeleteIcon onClick={() => deleteDomain(i)} />
									</HStack> : ""}
								</Td>
							</Tr>
						)}
