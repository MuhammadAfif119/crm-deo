...
function PricingDetail() {
  ...
  const checkOut = async (priceId, uid) => {
    const docref = await addDoc(
      collection(db, "customers", uid, "checkout_sessions"), //uid disini belum dinamis
      {
        price: priceId,
                ...
                <Stack>
                  <Stack alignItems="center">
                    ...
                    >
                      <InputLeftAddon
                        bgColor={"blue.400"}
                        children={<MdAccountCircle size={24} color="white" />}
                      />
                      <Input
                  ...
                  <Stack alignItems="center">
                    ...
                    >
                      <InputLeftAddon
                        bgColor={"blue.400"}
                        children={
                          <MdEmail name="email" size={24} color="white" />
                        }
                      />
                      <Input
                        w={{
                  ...
                  <Stack alignItems="center">
                    ...
                    >
                      <InputLeftAddon
                        bgColor={"blue.400"}
                        children={<MdLock size={24} color="white" />}
                      />
                      <Input
                        w={{
                          base: "100%",
