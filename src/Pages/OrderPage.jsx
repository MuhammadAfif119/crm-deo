...
function OrderPage() {
    ...
    return (
        <Stack bgColor={'gray.200'} p={5}>
            <HStack cursor='pointer' w='100px' zIndex='100' mx={5} p={2} alignItems='center' shadow={'base'} justifyContent={'center'} borderRadius='full' bgColor={colors.theme} onClick={() => navigate(-1)}>
