  ...
  const getDataUser = async () => {
    try {
      ...
      if (docSnap.exists()) {
        ...
        setSearchParams(
          `detail=${docSnap?.data()?.ayrshare_account[0].profileKey}&name=${
            docSnap?.data()?.ayrshare_account[0].title
          }`
        );
      } else {
      ...
      <Flex align="center" justify="center" px="4" mb="8">
        <Flex align="center">
          <IconButton
            ...
            icon={
              <Image w={isOpen ? "150px" : null} src={isOpen ? logo : logo} />
            }
            bg="transparent"
                        ...
                        socialAccountList?.map((x, index) => {
                          return (
                            <Stack
                              cursor={"pointer"}
                              onClick={() =>
                                handleActiveParams(x.profileKey, x.title)
                              }
                              ...
                              borderWidth={2}
                              borderColor={
                                searchParams.get("detail") === x.profileKey
                                  ? "blue.300"
                                  : "transparent"
                              }
                              borderRadius={"xl"}
